...
class ProductsResourceIT {
    ...
    public static Products createEntity(EntityManager em) {
        Products products = new Products().name(DEFAULT_NAME).price(DEFAULT_PRICE).description(DEFAULT_DESCRIPTION);
        return products;
    }
    ...
    public static Products createUpdatedEntity(EntityManager em) {
        Products products = new Products().name(UPDATED_NAME).price(UPDATED_PRICE).description(UPDATED_DESCRIPTION);
        return products;
    }
    ...
    void putNewProducts() throws Exception {
        ...
        updatedProducts.name(UPDATED_NAME).price(UPDATED_PRICE).description(UPDATED_DESCRIPTION);
    ...
    void partialUpdateProductsWithPatch() throws Exception {
        ...
        partialUpdatedProducts.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateProductsWithPatch() throws Exception {
        ...
        partialUpdatedProducts.name(UPDATED_NAME).price(UPDATED_PRICE).description(UPDATED_DESCRIPTION);
